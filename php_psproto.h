...
#	define PHP_PSPROTO_API __attribute__ ((visibility("default")))
#else
#	define PHP_PSPROTO_API
#endif
...
ZEND_BEGIN_MODULE_GLOBALS(psproto)
	zend_long  global_value;
	char *global_string;
ZEND_END_MODULE_GLOBALS(psproto)
*/

/* Always refer to the globals in your function as PSPROTO_G(variable).
